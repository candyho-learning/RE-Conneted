...
export default function EditableQuote({
  ...
  return (
    <div>
      ...
      {!isEditing && (
        <div className="mt-5 w-full h-18 mb-10 relative rounded-lg border-l-8 border-l-gray-500 bg-gray-200 py-5 pl-16 pr-5 font-sans text-lg italic leading-relaxed text-gray-600 before:absolute before:left-3 before:top-3 before:font-serif before:text-6xl before:text-gray-700 before:content-['“']">
